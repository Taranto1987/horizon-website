...
const FloatingWhatsApp = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setIsVisible(true);
      // Show message tooltip after 5 seconds
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Message Tooltip */}
      {showMessage && (
        <div className="absolute bottom-20 right-0 bg-white shadow-lg rounded-lg p-3 mb-2 max-w-xs animate-bounce">
      ...
      >
        <svg 
          className="w-8 h-8 animate-pulse group-hover:animate-none" 
          fill="currentColor" 
          viewBox="0 0 24 24"
        >
