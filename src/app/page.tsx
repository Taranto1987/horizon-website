          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="bg-purple-100 h-48 flex items-center justify-center">
                <div className="text-purple-600 text-6xl">🛏️</div>
              </div>
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold text-purple-600">A partir de R$ 1.299</span>
                  <Link href="/produtos" className="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition-colors">
                    Ver Mais
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold text-purple-600">A partir de R$ 999</span>
                  <Link href="/produtos" className="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition-colors">
                    Ver Mais
                  </Link>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold text-purple-600">A partir de R$ 1.599</span>
                  <Link href="/produtos" className="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition-colors">
                    Ver Mais
                  </Link>
                </div>
