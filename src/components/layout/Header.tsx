      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <div className="bg-purple-600 text-white px-3 py-2 rounded-lg font-bold text-xl">
              CASTOR
            </div>
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/produtos" className="text-gray-700 hover:text-purple-600 transition-colors font-medium">
              Produtos
            </Link>
            <Link href="/mapa" className="text-gray-700 hover:text-purple-600 transition-colors font-medium">
              Mapa do Sono IA
            </Link>
            <Link href="/sobre" className="text-gray-700 hover:text-purple-600 transition-colors font-medium">
              Sobre
            </Link>
          ...
          <div className="md:hidden py-4 border-t">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="pt-4 space-y-2">
                ...
                <a 
                  href="tel:22992410112" 
                  className="block text-gray-700 hover:text-purple-600 transition-colors font-medium text-center"
                >
                  (22) 99241-0112
                </a>
              </div>
