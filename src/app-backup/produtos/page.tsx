    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <a 
            href="https://wa.me/5522992410112?text=Olá! Gostaria de saber mais sobre ${product.name}. Pode me dar mais informações?" 
            target="_blank" 
      ...
      <section className="bg-[#C8102B] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="https://wa.me/5522992410112?text=Olá! Vi os produtos e gostaria de mais informações sobre os colchões Castor." 
              target="_blank" 
              rel="noopener noreferrer"
