        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/produtos" 
                className="bg-red-700 text-white px-8 py-4 rounded-lg font-semibold hover:bg-red-800 transition-colors inline-block"
                style={{backgroundColor: '#C8102B'}}
              >
                Ver Produtos
              </Link>
              <Link 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="bg-gray-100 h-48 flex items-center justify-center">
                <div className="text-gray-700 text-6xl">🛏️</div>
              </div>
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold" style={{color: '#C8102B'}}>A partir de R$ 1.299</span>
                  <Link href="/produtos" className="bg-red-700 text-white px-4 py-2 rounded hover:bg-red-800 transition-colors" style={{backgroundColor: '#C8102B'}}>
                    Ver Mais
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold" style={{color: '#C8102B'}}>A partir de R$ 999</span>
                  <Link href="/produtos" className="bg-red-700 text-white px-4 py-2 rounded hover:bg-red-800 transition-colors" style={{backgroundColor: '#C8102B'}}>
                    Ver Mais
                  </Link>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold" style={{color: '#C8102B'}}>A partir de R$ 1.599</span>
                  <Link href="/produtos" className="bg-red-700 text-white px-4 py-2 rounded hover:bg-red-800 transition-colors" style={{backgroundColor: '#C8102B'}}>
                    Ver Mais
                  </Link>
                </div>
