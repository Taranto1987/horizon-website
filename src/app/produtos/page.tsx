...
const ProductCard = ({ product }: { product: Product }) => {
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
      <div className="bg-gradient-to-br from-purple-50 to-purple-100 h-48 flex items-center justify-center">
        <div className="text-purple-600 text-6xl">{product.image}</div>
      </div>
      <div className="p-6">
